export default function About(){
    return (
    <div className="h1">
        {/* <video width="40%" controls loop autoplay="true" muted>
        <source src="C:\Users\phalg\OneDrive\Desktop\minor_project\minor\public\news_-_8957 (540p).mp4" type="video/mp4"/>
    </video> */}
    <video controls disabled loop autoplay="true" muted> <source src={'video.mp4'} type="video/mp4" /></video>
       <p>A news application is a big interactive database that tells a news story. Think of it like you would any other piece of journalism. It just uses software instead of words and pictures.
...
Figure 83. <em>Mapping LA</em> (Los Angeles Times)
